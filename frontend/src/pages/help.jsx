            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 md:grid-cols-2">
               <div>
                  ...
                  <div className="mb-10">
                     ...
                     <p className="text-gray-500">
                        You can create a checkings account by clicking on the "Create Account" button on the bottom of the
                        dashboard page.
                     </p>
                  </div>
                  <div className="mb-10">
                     ...
                     <p className="text-gray-500">
                        Yes, you can set up automatic banking transfers by clicking on the "Transfers" button in the
                        dashboard page.
                     </p>
                  </div>
                  <div className="mb-10">
               ...
               <div>
                  <div className="mb-10">
                     ...
                     <p className="text-gray-500">
                        You can apply for a credit card by clicking on the "Apply for Credit Card" button on the bottom of
                        the dashboard.
                     </p>
                  </div>
                  <div className="mb-10">
                     ...
                     <p className="text-gray-500">
                        ACU is a great way to manage your finances and keep track of your money.
                     </p>
                  </div>
                  <div className="mb-10">
                     <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900">
                     ...
                     <p className="text-gray-500">
                        You can delete a checkings/savings account by clicking on the "Delete Account" button on the bottom
                  ...
                  <div className="mb-10">
                     ...
                     <p className="text-gray-500">
                        You can create a savings account by clicking on the "Create Account" button on the bottom of the
                        dashboard page.
                     </p>
                  </div>
               </div>
